...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['知道了'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red"></p>暂无消息<p></p><p><span class="layui-red"></span></p></div>',
    ...
    function lockPage(){
        ...
        var src = $("#userHead").attr("src");
        var name = $("#userName").html();
        layer.open({
            title : false,
            type : 1,
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="'+src+'" class="userAvatar"/></div>'+
